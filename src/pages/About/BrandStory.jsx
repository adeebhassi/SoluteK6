...
export default function BrandStory() {
  const breadcrumbLinks = [
    ...
    const commonConnection = {
        ...
        description: "The Bridge Between Home and Heritage... US-based Kashmiri immigrants are the heartbeat of De Koshur Crafts’ journey.",
        textBoxes: [
          {
            heading: "Catalysts for Positive",
            highlightedText: "Change",
            description: "Kashmiri immigrants in the United States act as catalysts for transformation, leveraging their deep ties to Kashmir."
          },
          {
            heading: "Bridging Key",
            highlightedText: "Connections",
            description: "US-based Kashmiris create vital connections between major American companies and Kashmir’s handicraft sector."
          },
          {
            heading: "Advocates for a Unified",
            highlightedText: "Brand",
            description: "Kashmiri immigrants in the US champion the creation of a unified, globally recognized brand—De Koshur Crafts."
          },
          {
            heading: "Elevating Craft",
            highlightedText: "Standards",
            description: "De Koshur Crafts commits to elevating Kashmiri handicrafts to global standards. Through modern business practices."
          },
          {
            heading: "Preserving Cultural",
            highlightedText: "Heritage",
            description: "De Koshur Crafts embodies a deep reverence for Kashmiri cultural heritage. By merging centuries-old traditions."
          },
          {
            heading: "Framework for",
            highlightedText: "Empowerment",
            description: "Central to De Koshur Crafts’ mission is a holistic framework designed to uplift Kashmiri artisans."
          }
        ]
      };
