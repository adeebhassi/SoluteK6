        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-6">
            <div className="section-title text-left">
              ...
              {contactInfo.addresses.map((item, index) => (
                <div key={index} className="mb-5" style={{ lineHeight: "7px" }}>
                  ...
                  <p style={{ marginLeft: "2.5rem",lineHeight:'25px' }}>{item.address}</p>
                </div>
              ))}
              ...
              <div className="mb-5" style={{ lineHeight: "12px" }}>
                <h3 className="section-main-title">
                ...
                <p style={{ marginLeft: "2.5rem" }}>{contactInfo.coordination.timeZone.indiaAhead}</p>
                <br />
                <p style={{ marginLeft: "2.5rem" }}>
            ...
            <div className="contact_from_box">
              {/* Form can be dynamically added here */}
            </div>
          </div>
